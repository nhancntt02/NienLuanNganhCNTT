<template>
    <nav class="row navbar navbar-expand navbar-dark bg-primary py-3">
        ...
        <ul v-if="!getUserName" class="col navbar-nav d-flex justify-content-end">
            <li class="nav-item mx-1"><router-link :to="{ name: 'loginPage' }" class="nav-link fs-5">Đăng nhập</router-link>
            </li>
            <li class="nav-item"><router-link :to="{ name: 'registerPage' }" class="nav-link fs-5">Đăng ký</router-link></li>
            <li class="nav-item">
        ...
        <ul v-else class="col col-sm-5 navbar-nav d-flex justify-content-end">
            <li class="nav-item">
                <router-link :to="{ name: 'order' }" class="nav-link fs-5">Đơn hàng</router-link>
            </li>
            <li class="nav-item">
                <router-link :to="{ name: 'customerinfo' }" class="nav-link"><i class="fa-solid fa-user fs-3" title="Tài khoản"></i></router-link>
            </li>
            <li class="nav-item">
                <router-link :to="{ name: 'notify' }" class="nav-link position-relative">
                    <i class="fas fa-bell fs-3" title="Thông báo"></i>
            ...
            <li class="nav-item">
                <router-link :to="{name: 'cart'}" class="nav-link position-relative" href="">
                    <i class="fa-solid fa-cart-shopping fs-3" title="Giỏ hàng"></i>
                    <span v-if="cartCount != 0" class="position-absolute top-0 start-70 translate-middle badge rounded-pill bg-danger">
                        {{ cartCount }}
                    </span>
                </router-link>
            </li>
            <li class="nav-item"><a class="nav-link" href="#" @click="logout"><i class="fa-solid fa-arrow-right-from-bracket fs-3" title="Đăng xuất"></i></a></li>
        </ul>
    </nav>
</template>
